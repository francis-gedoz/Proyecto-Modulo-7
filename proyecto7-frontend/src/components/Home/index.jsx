            ...
            <main className="mx-4 md:mx-8 mt-8">
                <section className="mt-16 flex flex-col-reverse md:flex-row items-center md:items-stretch gap-8 min-h-[70vh]">
                    <div className="w-full md:w-1/2 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-4 text-gray-500 max-w-xl">Accede a nuestra variada gastronomía<br />(sujeto a disponibilidad)</p>
                        ...
                        <div className="mt-10 w-full max-w-xs mx-auto">
                            ...
                            >
                                ...
                                <option value="noreste">Región Noreste</option>
                                <option value="centro-oeste">Región Centro-Oeste</option>
                                <option value="sudeste">Región Sudeste</option>
